                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col} controlId="tema">
                            ...
                            <Form.Select className='opcion' name="tema" onChange={(e) => settema(e.target.value)}>
                                ...
                                <option value="1">derechos sexuales y reproductivos</option>
                                <option value="2">autocuidado</option>
                                <option value="3">habilidades blandas</option>
                                <option value="4">talleres de deporte</option>
                                <option value="5">talleres de cultura</option>
                            </Form.Select>
                        </Form.Group>
