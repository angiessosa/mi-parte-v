...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-10-2024 a las 06:39:37
...
--
-- Estructura de tabla para la tabla `usuariotaller`
--

CREATE TABLE `usuariotaller` (
  `idTaller` int(11) NOT NULL,
  `idUsuario` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `usuariotaller`
--
ALTER TABLE `usuariotaller`
  ADD PRIMARY KEY (`idTaller`,`idUsuario`),
  ADD KEY `idUsuarios` (`idUsuario`);
...
--
-- Filtros para la tabla `usuariotaller`
--
ALTER TABLE `usuariotaller`
  ADD CONSTRAINT `usuariotaller_ibfk_1` FOREIGN KEY (`idTaller`) REFERENCES `taller` (`idTaller`),
  ADD CONSTRAINT `usuariotaller_ibfk_2` FOREIGN KEY (`idUsuario`) REFERENCES `usuarios` (`idUsuario`);
COMMIT;
