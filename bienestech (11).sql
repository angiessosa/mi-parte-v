...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-10-2024 a las 07:21:14
...
INSERT INTO `usuarios` (`idUsuario`, `tipoDocumento`, `numeroDocumento`, `nombres`, `apellidos`, `correoUsuario`, `claveUsuario`, `idRol`, `estado`, `areaEncargada`) VALUES
(17, 'C.C', '11222221', 'Yudi', 'Moreno', 'yudimoreno@sena.edu.co', '$2a$12$yHsH0gsic4nwIMtK6fYVg.69q5XZGTsuM2MCOo2zUotwVpTSxGvCq', 1, 'aprobado', NULL),
(18, 'C.C', '22333344', 'Gustavo', 'Beltran', 'gustavob@sena.edu.co', '$2a$12$erTmjL01ooy9.FjkQR/nDuAbubnOhF0Na1YMXG/Hua9TBH6LWKVpq', 2, 'aprobado', NULL),
(23, 'C.C', '55544477', 'Sebastian', 'Ramirez', 'sebas@sena.edu.co', '$2a$12$6QmRoow.2Ey4ZHCUGRKiTOBvqhCzGv8ufTn8zXzP9DRfyApDf6ecK', 3, 'aprobado', 'arte'),
(24, 'C.C', '88883999', 'Maria', 'Suarez', 'mariassuar@sena.edu.co', '$2a$12$yIrBQfGH9vCVP6B22AClXuo.euCF3zNUyHT631LjtABja4NIHmONu', 4, 'aprobado', NULL),
(25, 'C.C', '1233344455', 'Juliana', 'Salgar', 'a@gmail.com', '$2a$12$WcLVdqqrK9x0IYBUqspPw.bG.3rspOC7vpcaLiQbOH2WvKP6.mWT2', 1, 'aprobado', NULL),
(30, 'C.C', '120022', 'Angie', 'Sosa', 'assosa2@soy.sena.edu.co', '$2a$12$VKTaH5.ATwIwfOg4jK7XW.69SOQwutPfqTZQU9iFBrCQdFOp.nkMC', 2, 'pendiente', NULL),
(35, 'C.C', '222222222', 'Valentina', 'Prueba', 'vale@soy.sena.edu.co', '$2b$12$P61lKhgz9CyjlHPA7RiNOOBOdfPJlqO/JOEMtbv4muNd9tgd8T50i', 1, 'denegado', NULL),
(36, 'C.C', '222222224', 'Valentina', 'Prueba', 'vale@soy.sena.edu.co', '$2b$12$87PkRCq3rYaBxvJ.E2Ns0OrVnEN297M.tpZkDFa4hDTkcPM5TZ1uS', 1, 'denegado', NULL),
(37, 'C.C', '222222223', 'Valentina', 'Prueba3', 'vale3@soy.sena.edu.co', '$2b$12$Ca25APZvtsgffDakjS7uJ.vMzv8.EJcJnLQRYUZoHEtNDHd3QnLmC', 2, 'denegado', NULL),
(38, 'C.C', '345677', 'Maria', 'Morneo', 'mariamm@gmail.com', '$2a$12$RQJaVSANdIetq5vjwcZx4Ogng9WKu4xfb2GhE9IRXYzY/M/4gbsNq', 1, 'pendiente', NULL),
(39, 'C.C', '120929', 'Camila', 'PrueC', 'cami12@gmail.com', '$2b$12$Cy66rSHhXRA4nAhjOux4zeqzmFl6L47Mcc8x/VEm1h9lMwi1OwhiC', 2, 'pendiente', NULL),
(40, 'C.C', 'd', '2', '223', 'assosa2@gm', '$2b$12$dDke8e3KJkmlShE2xhK2F.K9pLBti0fAEsdCPdHsYiBpFG/pXF0J6', 1, 'pendiente', NULL),
(41, 'C.C', '10127762', 'angie', 'sosaprueba', 'a@gmail.com', '$2b$12$d8TSw4qPSz4OW5T9.XTb/eqb9MmpfvijWQgij1Ne5eAfwinwmVUyK', 1, 'pendiente', NULL),
(42, 'C.C', '1111', 'Angie', 'pruebsa2', 'angiesod@gmail', '$2b$12$v5iWDE69yOL.VYVkyImopeY2GxNwRollseqh4O/Hm4JKGn5wxuZJW', 1, 'pendiente', NULL),
(43, 'C.C', 'rwrw', 'rwrwr', 'rwrwr', 'rwrw@j', '$2b$12$vkxuj/szJ13wJfxURrEVlueSGZILTGwuYC2tmy5FCcQlhSWfPMLp2', 1, 'pendiente', NULL);
...
--
ALTER TABLE `taller`
  MODIFY `idTaller` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
